...
---Exec #Lntsp_Invoice_PO_WO_TAT @fromdate = '01-Jan-2017',@Todate = '31-Mar-2018'
...
select mrdate, MrAuthDate, POAuth,DCDate, GinDate,	mrndate,MRNAuthDate,Invregisterdate,MinScrutinyDate,	MaxScrutinyDate,	JVDate,	MinDisbdate,	Maxdisbdate,	HPO_PO_Number,	BUdesc,	ICdesc,	TLREG_LR_Number, invvalue	
